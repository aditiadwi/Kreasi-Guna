...
| **WhatsApp SVG Logo Accuracy** | Ikon WA sebelumnya adalah siluet putih dasar yang rentan terpotong oleh CSS `overflow: hidden` di beberapa browser dan kurang menyerupai logo resmi WhatsApp. | Mengganti SVG siluet dengan SVG resmi WhatsApp bertumpuk 2-lapisan (balon chat putih + lingkaran hijau & telepon cut-out), serta membersihkan batasan overflow pada CSS untuk rendering yang 100% presisi. |
